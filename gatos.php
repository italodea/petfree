...
<body class="grey lighten-3">
	...
	<div id="container">
		...
		<div id="content" class="grey lighten-3">
    		...
    		<h4>Gatos cadastrados</h4>

    		<div class="card col s6 m5">
			    <div class="card-content">
			      <span class="card-title activator grey-text text-darken-4">@gato<i class="material-icons right">more_vert</i></span>
			    </div>
			    <div class="card-reveal">
			      <span class="card-title grey-text text-darken-4">@gato<i class="material-icons right">close</i></span>
			      <p>Características:</p>
			    </div>
			 </div>
    	</div>
